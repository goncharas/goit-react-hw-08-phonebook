...
export const VisibilityIconStyle = () => <VisibilityIcon sx={{ fill: '#a2a2a3' }} />;

export const VisibilityOffIconStyle = () => (
  <VisibilityOffIcon sx={{ fill: '#a2a2a3' }} />
);
...
export const GitHubIconStyle = () => (
  <FooterLink
    href="https://github.com/goncharas/goit-react-hw-08-phonebook"
    target="_blank"
...
export const LinkedInIconStyle = () => (
  <FooterLink
    href="https://www.linkedin.com/in/Honchar-Andrii/"
    target="_blank"
    rel="noopener noreferrer nofollow"
  >
    <LinkedInIcon
